...
namespace Ciano.Utils {
    ...
    public class FileUtil {
	     ...
	     *         Based on code - Jeremy Wootten <jeremy@elementaryos.org>
	     *         	https://github.com/elementary/files/blob/ac10bd5a7298a89bb1a53eefd24a2991539f91a5/pantheon-files-daemon/FileManager1.vala
	     *
	     * Exemple:
