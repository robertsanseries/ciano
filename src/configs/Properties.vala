...
namespace Ciano.Configs {
    ...
    public class Properties {
        ...
        public abstract const string PROGRAME_NAME = _("Ciano"); 
        ...
        public abstract const string TEXT_OUTPUT_SOURCE_FILE_FOLDER = _("Output to source file folder:");
        public abstract const string TEXT_AFTER_CONVERTING = _("After converting:");
        public abstract const string TEXT_SHUTDOWN_COMPUTER = _("Shutdown computer:");
        ...
        public abstract const string TEXT_DEFAULT_SETTINGS = _("Default Settings");
        ...
        public abstract const string TEXT_ADD_FOLDER = _("Add Folder…");
        public abstract const string TEXT_SELECT_FOLDER = _("Select a folder");
        ...
        public abstract const string TEXT_SELECT_OPTION_TO_CONVERT = _("Select an option for which you want to \n convert your file");
        ...
        public abstract const string TEXT_ERROR_IN_CONVERSION_PROCESS = _("Error in conversion process");
