...
namespace Ciano.Services {
    ...
    public class Settings : Object {
        ...
        /**
         * Maximum number of simultaneous conversions allowed.
         * Ignored when {@code use_cpu_cores_limit} is {@code true}.
         */
        public int max_simultaneous_conversions { get; set; default = 0; }

        /**
         * When {@code true}, the number of CPU cores is used as the simultaneous
         * conversions limit, overriding {@code max_simultaneous_conversions}.
         */
        public bool use_cpu_cores_limit { get; set; default = true; }
        ...
        private Settings () {
            ...
            schema.bind ("max-simultaneous-conversions", this, "max-simultaneous-conversions", SettingsBindFlags.DEFAULT);
            schema.bind ("use-cpu-cores-limit", this, "use-cpu-cores-limit", SettingsBindFlags.DEFAULT);
            ...
            // Set default conversion limit to CPU core count on first run
            if (this.max_simultaneous_conversions == 0) {
                this.max_simultaneous_conversions = int.max (1, (int) GLib.get_num_processors () / 2);
            }
        }
