...
namespace Ciano.Widgets {
    ...
    public class ListConversion : Gtk.Grid {
        ...
        private void build_welcome_view () {
            ...
            var title_label = new Gtk.Label (_("Empty conversion list"));
            title_label.add_css_class ("title");

            var desc_label = new Gtk.Label (_("Select an option from the side menu to which you want to \n convert your file")); // vala-lint=line-length
