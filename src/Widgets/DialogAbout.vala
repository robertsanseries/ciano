...
namespace Ciano.Widgets {
    ...
    public class DialogAbout : Gtk.Window {
        ...
        private const string DESCRIPTION = _("A multimedia file converter focused on simplicity.");
        ...
        private void build_ui () {
            ...
            license_label.set_markup (
                    "%s <a href=\"%s\">%s</a>.".printf (
                            _("This program is published under the terms of the GNU General Public License; it comes with ABSOLUTELY NO WARRANTY; for details, visit: "), // vala-lint: disable=line-length
